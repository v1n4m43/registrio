...
<link rel="stylesheet" href="{{ asset('home/css/register_request.css')}}">
    ...
    <div class="box-title">
        <center><h1>Online Application<br>Request</h1></center>
    </div>
    ...
    <div class="container">
        <div class="box">
            ...
            <div class="expand-button">
                <img src="{{ asset('home/image/birth-request-button.png') }}" alt="Birth Request">
            </div>
        </div>
        <div class="box">
            <div class="title">
            ...
            <div class="expand-button">
                <img src="{{ asset('home/image/marriage-request-button.png') }}" alt="Marriage Request">
            </div>
        </div>
        <div class="box">
            <div class="title">
            ...
            <div class="expand-button">
                <img src="{{ asset('home/image/death-request-button.png') }}" alt="Death Request">
            </div>
        </div>
    </div>
    ...
    <div class="popup-overlay" id="questionPopupOverlay">
        <div class="popup-container">
            ...
            <div class="popup-buttons">
                ...
                <a href="{{ url('login') }}"><button id="btnNext">Next</button></a>
            </div>
        </div>
    </div>
