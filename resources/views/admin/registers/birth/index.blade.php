    ...
    <div class="col-sm-12 col-xl-12">
         ...
         <div class="col-sm-12 col-xl-12">
             <div class="bg-light rounded h-100 p-4">
                 <div class="row">
                     <div class="col-9">
                   <h6 class="mb-4">Registration Birth Certificate</h6>
               </div>
                 <div class="col-3">
                     <button type="button" class="btn btn-outline-warning m-2" data-bs-toggle="modal" data-bs-target="#BirthRegisterModal">Birth Registration</button>
                 </div>
                </div>
                 <hr></hr>
