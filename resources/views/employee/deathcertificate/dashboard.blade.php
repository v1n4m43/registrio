{{-----------------------------------------------DO NOT REMOVE---------------------------------------------------}}
@include('employee.deathcertificate.layouts.header')
@include('employee.deathcertificate.layouts.sidebar')
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
            @include('employee.deathcertificate.layouts.navbar')
...
@include('employee.deathcertificate.layouts.footer')
