{{-----------------------------------------------DO NOT REMOVE---------------------------------------------------}}
@include('employee.marriagecertificate.layouts.header')
@include('employee.marriagecertificate.layouts.sidebar')
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
            @include('employee.marriagecertificate.layouts.navbar')
    ...
    <div class="col-sm-12 col-xl-12">
         ...
         <div class="col-sm-12 col-xl-12">
             <div class="bg-light rounded h-100 p-4">
                 ...
                 <div class="col-3">
                     <button type="button" class="btn btn-outline-warning m-2" data-bs-toggle="modal" data-bs-target="#BirthRegisterModal">Marriage Registration</button>
                 </div>
                </div>
                 <hr></hr>
...
@include('employee.marriagecertificate.layouts.footer')
